...
function ScrollTicker() {
  ...
  return (
    <div className="relative w-full overflow-hidden py-6 border-y border-white/6">
      <motion.div
    ...
    >
      ...
      <div className={`relative w-full aspect-4/5 lg:aspect-auto lg:min-h-[600px] overflow-hidden ${isEven ? "order-1" : "order-1 lg:order-2"}`}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:hidden">
          <span className="text-accent-gold uppercase tracking-[0.2em] text-[10px] font-bold mb-2 block">
        ...
        <div className="absolute top-6 left-6 lg:top-8 lg:left-8">
          <span className="text-white/10 font-serif text-7xl lg:text-9xl font-bold leading-none group-hover:text-white/20 transition-colors duration-700">
      ...
      {/* Content Side */}
      <div className={`relative flex flex-col justify-center p-8 sm:p-10 lg:p-14 xl:p-20 bg-[#0e0e0e] border-y border-white/4 ${isEven ? "order-2" : "order-2 lg:order-1"}`}>
        ...
        >
          ...
          <motion.h3
            variants={fadeUp}
            className="font-serif text-3xl sm:text-4xl lg:text-5xl text-white mb-4 leading-tight hidden lg:block"
          >
            {service.title}
          </motion.h3>
          ...
          <motion.p
            variants={fadeUp}
            className="font-serif italic text-white/30 text-sm sm:text-base mb-6"
          >
            {service.tagline}
          </motion.p>
          ...
          <motion.p
            variants={fadeUp}
            className="text-white/50 text-sm sm:text-base font-light leading-relaxed mb-8 max-w-md"
          >
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap gap-x-6 gap-y-3 mb-8">
            {service.startingPrice && (
              <div>
                <span className="text-white/20 text-[9px] uppercase tracking-widest font-bold block mb-1">
            ...
            {service.minDuration && (
              <div>
                ...
                <span className="text-white/70 font-serif text-xl">
                  {service.minDuration}
                </span>
              </div>
            )}
...
export default function ServicesShowcase() {
  ...
  return (
    <>
      {/* ── Hero Section ── */}
      <section ref={heroRef} className="relative h-[90vh] sm:h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-[#0a0a0a]">
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(201,169,110,0.15), transparent)",
            }}
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.5, 0.3],
        ...
        >
          ...
          >
            {servicesPageConfig.heroTitle.split(" ").map((word, i, arr) =>
              i === arr.length - 1 ? (
                <span key={i} className="italic text-white/50">
                  {word}
                </span>
              ) : (
          ...
          <motion.p
            ...
            className="text-white/40 text-sm sm:text-base max-w-lg mx-auto font-light leading-relaxed"
          >
          ...
          >
            <span className="text-white/20 text-[9px] uppercase tracking-[0.4em] font-bold">
              Explore
            </span>
      ...
      {/* ── Bottom CTA ── */}
      <section className="relative w-full bg-[#0a0a0a] py-20 sm:py-32">
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="font-serif text-4xl sm:text-6xl lg:text-7xl text-white mb-6"
          >
            Let&apos;s Create <span className="italic text-white/50">Together</span>
          </motion.h2>
          <motion.p
            variants={fadeUp}
            className="text-white/40 text-sm sm:text-base max-w-md mx-auto mb-10 font-light"
          >
          ...
          <motion.div variants={fadeUp}>
            <Link
              ...
              className="inline-flex items-center gap-3 px-10 py-4 bg-accent-gold text-black text-xs uppercase tracking-[0.2em] font-bold rounded-full hover:bg-white transition-all duration-500 shadow-lg shadow-accent-gold/20 hover:shadow-white/20 group"
            >
